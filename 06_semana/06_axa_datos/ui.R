      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            status = "primary",
            solidHeader = TRUE,
            plotlyOutput("data_lake_progress", height = 500),
            width = 6
          ),
          box(
            ...
            status = "primary",
            solidHeader = TRUE,
            plotlyOutput("financial_impact", height = 500),
            width = 6
          )
        ),
        fluidRow(
          box(
            ...
            status = "primary",
            solidHeader = TRUE,
            plotlyOutput("heatmap_progress", height = 500),
            width = 12
          )
        )
      ),
      ...
      tabItem(
        ...
        fluidRow(
          box(
            ...
            status = "warning",
            solidHeader = TRUE,
            plotlyOutput("dacs_plot", height = 650),  # Altura aumentada
            width = 6
          ),
          box(
            ...
            status = "warning",
            solidHeader = TRUE,
            plotlyOutput("kpi_monitoring", height = 500),
            width = 6
          )
        ),
        fluidRow(
          box(
            ...
            status = "warning",
            solidHeader = TRUE,
            plotlyOutput("dacs_components", height = 500),
            width = 12
          )
        )
      ),
